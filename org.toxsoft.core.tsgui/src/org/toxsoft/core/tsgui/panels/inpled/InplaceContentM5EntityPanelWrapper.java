...
/**
 * {@link AbstractContentPanel} implementation wrapping over {@link IM5EntityPanel}.
 * <p>
 * TODO this class must move to the tsgui.M5
 *
 * @author hazard157
 * @param <T> - modeled entity type
 */
public class InplaceContentM5EntityPanelWrapper<T>
   ...
   */
  public InplaceContentM5EntityPanelWrapper( ITsGuiContext aContext, IM5EntityPanel<T> aM5Panel ) {
    super( aContext );
