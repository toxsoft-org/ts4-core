...
public class ScrollBarSettings
   ...
   */
  public ScrollBarSettings( ScrollBarSettings aSource ) {
   ...
   */
  public ScrollBarSettings( int aSelection, int aMinimum, int aMaximum, int aThumb, int aIncrement, int aPageIncr ) {
   ...
   * @return {@link ScrollBarSettings} - created instance
   * @throws TsNullArgumentRtException any argument = <code>null</code>
   */
  public static ScrollBarSettings of( ScrollBar aScrollBar ) {
    TsNullArgumentRtException.checkNull( aScrollBar );
    return new ScrollBarSettings( aScrollBar.getSelection(), aScrollBar.getMinimum(), aScrollBar.getMaximum(),
   ...
   */
  public static ScrollBarSettings ofTuned( int aVp1, int aVp2, int aContentSize, int aOrigin ) {
    ScrollBarSettings sbs = new ScrollBarSettings();
   ...
   *
   * @param aSource {@link ScrollBarSettings} - the source
   * @throws TsNullArgumentRtException any argument = <code>null</code>
   */
  public void copyFrom( ScrollBarSettings aSource ) {
  ...
  public boolean equals( Object aThat ) {
    ...
    if( aThat instanceof IScrollBarSettings that ) {
