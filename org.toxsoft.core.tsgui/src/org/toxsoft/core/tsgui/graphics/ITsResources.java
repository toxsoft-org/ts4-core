...
interface ITsResources {
  ...
  String STR_BT_NONE                 = Messages.getString( "EBorderType.STR_BT_NONE" );          //$NON-NLS-1$
  String STR_BT_NONE_D               = Messages.getString( "EBorderType.STR_BT_NONE_D" );        //$NON-NLS-1$
  String STR_BT_LINE                 = Messages.getString( "EBorderType.STR_BT_LINE" );          //$NON-NLS-1$
  String STR_BT_LINE_D               = Messages.getString( "EBorderType.STR_BT_LINE_D" );        //$NON-NLS-1$
  String STR_BT_ECTHED               = Messages.getString( "EBorderType.STR_BT_ECTHED" );        //$NON-NLS-1$
  String STR_BT_ECTHED_D             = Messages.getString( "EBorderType.STR_BT_ECTHED_D" );      //$NON-NLS-1$
  String STR_BT_CONVEX               = Messages.getString( "EBorderType.STR_BT_CONVEX" );        //$NON-NLS-1$
  String STR_BT_CONVEX_D             = Messages.getString( "EBorderType.STR_BT_CONVEX_D" );      //$NON-NLS-1$
  String STR_BT_BEVEL_INNER          = Messages.getString( "EBorderType.STR_BT_BEVEL_INNER" );   //$NON-NLS-1$
  String STR_BT_BEVEL_INNER_D        = Messages.getString( "EBorderType.STR_BT_BEVEL_INNER_D" ); //$NON-NLS-1$
  String STR_BT_BEVEL_OUTER          = Messages.getString( "EBorderType.STR_BT_BEVEL_OUTER" );   //$NON-NLS-1$
  String STR_BT_BEVEL_OUTER_D        = Messages.getString( "EBorderType.STR_BT_BEVEL_OUTER_D" ); //$NON-NLS-1$
  String STR_HA_LEFT                 = Messages.getString( "EHorAlignment.STR_HA_LEFT" );        //$NON-NLS-1$
  String STR_HA_LEFT_D               = Messages.getString( "EHorAlignment.STR_HA_LEFT_D" );      //$NON-NLS-1$
  String STR_HA_CENTER               = Messages.getString( "EHorAlignment.STR_HA_CENTER" );      //$NON-NLS-1$
  String STR_HA_CENTER_D             = Messages.getString( "EHorAlignment.STR_HA_CENTER_D" );    //$NON-NLS-1$
  String STR_HA_RIGHT                = Messages.getString( "EHorAlignment.STR_HA_RIGHT" );       //$NON-NLS-1$
  String STR_HA_RIGHT_D              = Messages.getString( "EHorAlignment.STR_HA_RIGHT_D" );     //$NON-NLS-1$
  String STR_HA_FILL                 = Messages.getString( "EHorAlignment.STR_HA_FILL" );        //$NON-NLS-1$
  String STR_HA_FILL_D               = Messages.getString( "EHorAlignment.STR_HA_FILL_D" );      //$NON-NLS-1$
  String STR_TSO_HORIZONTAL          = Messages.getString( "STR_TSO_HORIZONTAL" );               //$NON-NLS-1$
  String STR_TSO_HORIZONTAL_D        = Messages.getString( "STR_TSO_HORIZONTAL_D" );             //$NON-NLS-1$
  String STR_TSO_VERTICAL            = Messages.getString( "STR_TSO_VERTICAL" );                 //$NON-NLS-1$
  String STR_TSO_VERTICAL_D          = Messages.getString( "STR_TSO_VERTICAL_D" );               //$NON-NLS-1$
