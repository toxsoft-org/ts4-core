 ...
 * @author vs
 */
public class ConicalGradientFraction
   ...
   */
  public ConicalGradientFraction( double aStartValue, RGBA aStartRgb, double aEndValue, RGBA aEndRgb ) {
    super( aStartValue, aEndValue, aStartRgb, aEndRgb );
    // nop
  }
  ...
  public RGBA calcRgb( double aValue ) {
    ...
    if( (red > 255) || (red < 0) || (g > 255) || (g < 0) || (b > 255) || (b < 0) ) {
  ...
  protected IGradientFraction create( double aStartValue, double aEndValue, RGBA aStartRGB, RGBA aEndRGB ) {
    return new ConicalGradientFraction( aStartValue, aStartRGB, aEndValue, aEndRGB );
  }
