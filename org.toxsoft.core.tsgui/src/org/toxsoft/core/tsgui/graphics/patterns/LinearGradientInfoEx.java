 ...
 * @author vs
 */
public class LinearGradientInfoEx
   ...
   * Keeper singleton.
   */
  private static final IEntityKeeper<LinearGradientInfoEx> INTERNAL_KEEPER =
      new AbstractEntityKeeper<>( LinearGradientInfoEx.class, EEncloseMode.ENCLOSES_BASE_CLASS, null ) {

        @Override
        protected void doWrite( IStrioWriter aSw, LinearGradientInfoEx aEntity ) {
        ...
        @Override
        protected LinearGradientInfoEx doRead( IStrioReader aSr ) {
          ...
          aSr.ensureChar( '}' );
          return new LinearGradientInfoEx( centerX, centerY, fractions );
        }
      };
   ...
   */
  public static final IEntityKeeper<LinearGradientInfoEx> keeper() {
   ...
   */
  public LinearGradientInfoEx( double aCenterX, double aCenterY, IList<Pair<Double, RGBA>> aFractions ) {
    centerX = aCenterX;
    centerY = aCenterY;
  ...
  public IGradient createGradient( ITsGuiContext aContext ) {
    return new LinearGradientEx( this, aContext );
  }
