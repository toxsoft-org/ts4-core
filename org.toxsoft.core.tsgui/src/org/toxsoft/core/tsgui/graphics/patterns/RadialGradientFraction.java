 ...
 * @author vs
 */
public class RadialGradientFraction
   ...
   */
  public RadialGradientFraction( double aStartValue, RGBA aStartRgb, double aEndValue, RGBA aEndRgb ) {
  ...
  protected IGradientFraction create( double aStartValue, double aEndValue, RGBA aStartRGB, RGBA aEndRGB ) {
    return new RadialGradientFraction( aStartValue, aStartRGB, aEndValue, aEndRGB );
  }
