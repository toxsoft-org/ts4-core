 ...
 * @author vs
 */
public class PanelTsImageSourceEditor
  ...
  PanelTsImageSourceEditor( Composite aParent, TsDialog<TsImageDescriptor, ITsGuiContext> aOwnerDialog ) {
   ...
   */
  public PanelTsImageSourceEditor( Composite aParent, ITsGuiContext aContext, TsImageDescriptor aData, int aFlags ) {
