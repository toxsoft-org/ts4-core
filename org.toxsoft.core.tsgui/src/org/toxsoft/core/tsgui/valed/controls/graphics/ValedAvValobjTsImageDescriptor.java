 ...
 * @author vs
 */
public class ValedAvValobjTsImageDescriptor
    extends AbstractAvValobjWrapperValedControl<TsImageDescriptor> {

  /**
   * The factory name.
   */
  public static final String FACTORY_NAME = VALED_EDNAME_PREFIX + ".AvValobjTsImageDescriptor"; //$NON-NLS-1$
  ...
  static class Factory
    ...
    protected IValedControl<IAtomicValue> doCreateEditor( ITsGuiContext aContext ) {
      return new ValedAvValobjTsImageDescriptor( aContext );
    }
  ...
  protected ValedAvValobjTsImageDescriptor( ITsGuiContext aTsContext ) {
    super( aTsContext, ValedTsImageDescriptor.FACTORY );
  }
