...
/**
 * This multi lookup field editor contains just a factory invoking editor with requested widget type.
 * <p>
...
public class ValedMultiLookupEditor {

  /**
   * The factory name.
   */
  public static final String FACTORY_NAME = VALED_EDNAME_PREFIX + ".MultiLookupEditor"; //$NON-NLS-1$
  ...
  public static final AbstractValedControlFactory FACTORY = new AbstractValedControlFactory( FACTORY_NAME ) {
    ...
    protected AbstractValedControl doCreateEditor( ITsGuiContext aContext ) {
      switch( M5_VALED_OPDEF_WIDGET_TYPE_ID.getValue( aContext.params() ).asString() ) {
        case M5VWTID_TABLE:
        default:
          return new ValedMultiLookupTableEditor<>( aContext );
      }
    }
    ...
    protected AbstractValedControl doCreateViewer( ITsGuiContext aContext ) {
      ...
      switch( M5_VALED_OPDEF_WIDGET_TYPE_ID.getValue( aContext.params() ).asString() ) {
        ...
        default:
          return new ValedMultiLookupTableEditor<>( aContext );
        case M5VWTID_TEXT:
          return new ValedMultiLookupTextViewer<>( aContext );
      }
    }
