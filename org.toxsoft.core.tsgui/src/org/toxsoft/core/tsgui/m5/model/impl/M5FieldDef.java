...
public class M5FieldDef<T, V>
   ...
   * <p>
   * This method is called if non-<code>null</code> getter was not specified by user in
   ...
   * <p>
   * As defined by M5 modeling specification <code>null</code> may be returne@d only for simple single reference fields
