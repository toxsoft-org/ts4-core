...
public sealed class Ugwi
  ...
  /**
   * The kind ID of the {@link #NONE} UGWI.
   */
  public static final String KIND_ID_NONE = IStridable.NONE_ID;
  ...
  protected Ugwi() {
    ...
    canonicalString = KIND_ID_NONE + CHAR_KIND_SEPARATOR + CHAR_NAMEPSACE_SEPARATOR + CHAR_NAMEPSACE_SEPARATOR;
  }
   ...
   * @throws TsIllegalArgumentRtException kind ID is {@link #KIND_ID_NONE}
