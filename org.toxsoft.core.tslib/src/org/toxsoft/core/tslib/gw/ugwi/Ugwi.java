package org.toxsoft.core.tslib.gw.ugwi;

import static org.toxsoft.core.tslib.gw.ugwi.ITsResources.*;
 ...
 * IDpath. It is assumed that somewhere else there is UGWI kinds registry for UGWI processing.;</li>
 * <li><i>namespace</i> - determines optional context(domain) where to find entity pointed by the UGWI. ;</li>
 * <li><i>essence</i> - string is interpreted by the assumed UGWI kind implementation. {@link Ugwi} does not knows what
 * the <i>essence</i> means. Note that leading and trailing spaces are not allowed for essence.</li>
 * </ul>
 * <p>
 *
 * @author hazard157
...
public sealed class Ugwi
   ...
   *
   * @param aStr String - the calnoncal string
   * @return {@link Ugwi} - vcreated instance
   * @throws TsNullArgumentRtException any argument = <code>null</code>
   * @throws TsIllegalArgumentRtException canionical string format violation
   */
   ...
   * <p>
   * Method {@link #parseCanonicalString(String)} will return successfully if and only if this method does not returners
   * error,
   *
