 ...
 * <ul>
 * // *
 * <li><b>opset</b> - is powerful identified options container {@link org.toxsoft.core.tslib.av.opset.IOptionSet
 * IOptionSet};</li>
 * <li><b>metainfo</b> - meta information about atomic values includes
 * {@link org.toxsoft.core.tslib.av.metainfo.IDataType IDataType} type constraints set and
 * {@link org.toxsoft.core.tslib.av.metainfo.IDataDef IDataDef} to manipulate options;</li>
 * <li><b>validation</b> - is set of {@link org.toxsoft.core.tslib.bricks.validator.ITsValidator ITsValidator}
 * implementations for atomic values;</li>
 * <li><b>other</b> - other abilities includes math operations support,
 * {@link org.toxsoft.core.tslib.av.temporal.ITemporalAtomicValue ITemporalAtomicValue},
 * {@link org.toxsoft.core.tslib.av.misc.AvTextParser AvTextParser} to interpret human readable text as atomic values
 * and more.</li>
 * </ul>
 ...
 * <li><b>geometry</b> - basics {@link org.toxsoft.core.tslib.bricks.geometry.ITsPoint ITsPoint} and
 * {@link org.toxsoft.core.tslib.bricks.geometry.ITsRectangle ITsRectangle}, 2D <code>double</code> coordinates entities
 * like {@link org.toxsoft.core.tslib.bricks.d2.ID2Point ID2Point},
 * {@link org.toxsoft.core.tslib.bricks.d2.ID2Conversion ID2Conversion}, etc;</li>
 * <li><b>filebound</b> - {@link org.toxsoft.core.tslib.bricks.filebound.IKeepedContentFileBound
 * IKeepedContentFileBound} connects some editable content to the files and makes easy to implement GUI commands
 * New/Open/Save/SaveAs;</li>
 * </ul>
 ...
 * {@link org.toxsoft.core.tslib.utils.files.TsFileFilter TsFileFilter} to work with {@link java.io.File File}s;</li>
 ...
 * {@link org.toxsoft.core.tslib.utils.progargs.ProgramArgs ProgramArgs} class is introduced;</li>
