 ...
 */
public class SortedStridMap<E>
    extends SortedStringMap<E> {
   ...
   */
  public SortedStridMap( boolean aIsIdPathAllowed, boolean aIsDupElemsAllowed, int aBucketsCount ) {
    super( aBucketsCount );
   ...
   *          <b>false</b> - value equal to existing one with different key can not be added to the map.
   */
  public SortedStridMap( boolean aIsIdPathAllowed, boolean aIsDupElemsAllowed ) {
    super();
    allowIdPath = aIsIdPathAllowed;
    allowDupElems = aIsDupElemsAllowed;
  }
