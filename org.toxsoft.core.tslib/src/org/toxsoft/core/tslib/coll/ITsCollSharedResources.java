...
public interface ITsCollSharedResources {

  String FMT_ERR_ITEM_NOT_FOUND_BY_KEY             = Messages.getString( "FMT_ERR_ITEM_NOT_FOUND_BY_KEY" );             //$NON-NLS-1$
  String FMT_ERR_INV_INITIAL_CAPACITY              = Messages.getString( "FMT_ERR_INV_INITIAL_CAPACITY" );              //$NON-NLS-1$
