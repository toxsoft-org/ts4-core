...
public interface ITsInitializable {
   ...
   * <p>
   * It is assumed that component may store reference to the argument for the whole lifetime. Container must ensure that
   * argument is an instance created for such a purpose and will not be modified from outside for other purposes.
   *
