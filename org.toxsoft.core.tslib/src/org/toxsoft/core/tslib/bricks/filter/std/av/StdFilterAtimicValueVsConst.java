package org.toxsoft.core.tslib.bricks.filter.std.av;
 ...
 * @author hazard157
 */
public final class StdFilterAtimicValueVsConst
  ...
  public static final ITsSingleFilterFactory<IAtomicValue> FACTORY =
      new AbstractTsSingleFilterFactory<>( TYPE_ID, IAtomicValue.class ) {
        ...
        protected ITsFilter<IAtomicValue> doCreateFilter( IOptionSet aParams ) {
          ...
          return new StdFilterAtimicValueVsConst( op, constant );
        }
      };
   ...
   */
  public StdFilterAtimicValueVsConst( EAvCompareOp aOp, IAtomicValue aConst ) {
