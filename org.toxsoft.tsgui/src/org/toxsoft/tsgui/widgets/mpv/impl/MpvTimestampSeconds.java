...
import org.toxsoft.tsgui.widgets.mpv.IMpvTimestamp;
import org.toxsoft.tslib.coll.primtypes.IIntList;
import org.toxsoft.tslib.math.IntRange;
import org.toxsoft.tslib.utils.errors.TsNullArgumentRtException;

/**
 * {@link IMpvTimestamp} implementation in form "YYYY-MM-DD HH:MM:SS".
 *
 * @author goga
 */
public class MpvTimestampSeconds
    extends AbstractMpvTimestamp {

  /**
   * Constructor.
   */
  public MpvTimestampSeconds() {
