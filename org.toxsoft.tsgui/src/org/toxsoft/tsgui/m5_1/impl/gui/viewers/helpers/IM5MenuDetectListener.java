 ...
 */
public interface IM5MenuDetectListener<T> {

  /**
   * "Нулевой" слушатель, ничего не делает.
   * <p>
   * Предназначено для передачи в {@link IM5MenuManager#setMenuDetectListener(IM5MenuDetectListener)} вместо null.
   */
  @SuppressWarnings( "rawtypes" )
  IM5MenuDetectListener NULL = new InternalNullMenuDetectListener();
...
class InternalNullMenuDetectListener
    implements IM5MenuDetectListener<Object> {
