...
import static org.toxsoft.tsgui.m5_3.gui.panels.impl.ITsResources.*;
...
import org.toxsoft.tsgui.valed.controls.enums.IValedEnumConstants;
import org.toxsoft.tsgui.valed.controls.enums.ValedEnumCombo;
import org.toxsoft.tsgui.valed.controls.time.*;
...
public class M5EntityPanelWithValeds<T>
  ...
  private IValedControl<?> createEditor( IM5FieldDef<T, ?> aFieldDef ) {
    ...
    if( aFieldDef.params().getValue( OPDEF_EDITOR_FACTORY_NAME ).isAssigned() ) {
      ...
      String edName = aFieldDef.params().getStr( OPDEF_EDITOR_FACTORY_NAME );
