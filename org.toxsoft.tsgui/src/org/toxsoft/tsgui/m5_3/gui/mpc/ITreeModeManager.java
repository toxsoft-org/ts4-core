...
import org.toxsoft.tsgui.m5_3.gui.mpc.impl.TreeModeInfo;
 ...
 * <p>
 * При смене текущего режима {@link #getCurrentModeId()} или наличия режима дерева {@link #hasTreeMode()} генерируется
...
public interface ITreeModeManager<T>
   ...
   * <p>
   * Возвращает результат проверки <code>{@link #getCurrentModeId()} != null</code>.
   *
