package org.toxsoft.tsgui.graphics.fonts.impl;

import static org.toxsoft.tsgui.graphics.fonts.impl.ITsResources.*;
...
import org.toxsoft.tsgui.graphics.fonts.IFontInfo;
...
public class TsFontManager
  ...
  // ------------------------------------------------------------------------------------
  // Реализация интерфейса ITsFontManager
  //
