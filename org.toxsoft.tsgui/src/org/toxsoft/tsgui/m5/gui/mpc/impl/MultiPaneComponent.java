...
import static org.toxsoft.tsgui.m5.gui.mpc.IMultiPaneComponentConstants.*;
...
import org.toxsoft.tsgui.bricks.stdevents.impl.*;
import org.toxsoft.tsgui.bricks.tstree.tmm.*;
...
import org.toxsoft.tsgui.m5.gui.mpc.IMultiPaneComponent;
import org.toxsoft.tsgui.m5.gui.mpc.IMultiPaneComponentConstants;
import org.toxsoft.tsgui.m5.gui.panels.*;
import org.toxsoft.tsgui.m5.gui.viewers.IM5Column;
import org.toxsoft.tsgui.m5.gui.viewers.IM5TreeViewer;
import org.toxsoft.tsgui.m5.gui.viewers.impl.M5DefaultTreeMaker;
...
import org.toxsoft.tslib.coll.helpers.ETsCollMove;
...
public class MultiPaneComponent<T>
  ...
  private final IGenericChangeListener filterPaneChangeListener =
      aSource -> tree().filterManager().setFilter( filterPane().getFilter() );
