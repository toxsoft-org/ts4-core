...
public abstract class VedAbstractItemFactory<T extends VedAbstractItem>
  ...
  @Override
  public T create( IVedItemCfg aCfg, IVedEnvironment aEnv ) {
   ...
   * @param aEnv {@link IVedEnvironment} the environment
   ...
   */
  protected abstract T doCreate( IVedItemCfg aCfg, IVedEnvironment aEnv );
