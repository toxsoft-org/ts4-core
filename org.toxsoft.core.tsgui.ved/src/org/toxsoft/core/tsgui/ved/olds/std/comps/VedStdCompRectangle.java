package org.toxsoft.core.tsgui.ved.olds.std.comps;
...
import org.toxsoft.core.tsgui.ved.olds.std.library.*;
...
public class VedStdCompRectangle
  ...
  static class StdRectView
      ...
      implements IVedViewPainter, IVedPorter {
    ...
    @Override
    public IVedViewPainter painter() {
      return this;
    }
    ...
    @Override
    public void paint( GC aGc, ITsRectangle aBounds ) {
