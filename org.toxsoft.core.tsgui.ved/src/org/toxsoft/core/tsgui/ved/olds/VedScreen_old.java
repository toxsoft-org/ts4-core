...
public class VedScreen_old
  ...
  public VedScreen_old( TsAbstractCanvas aParent, IVedEnvironment aEnvironment ) {
    super( aParent, aParent.tsContext() );
    ...
    dataModel.listComponents().addCollectionChangeListener( ( aSource, aOp, aItem ) -> {
      if( aOp == ECrudOp.CREATE ) {
        ...
        for( IVedComponent comp : dataModel.listComponents() ) {
          views.add( comp.createView( VedScreen_old.this ) );
        }
  ...
  @Override
  public void close() {
    // TODO remove screen from mscreen manager's list
    // TODO remove and dispose views
    // TODO dispose screen
  }
