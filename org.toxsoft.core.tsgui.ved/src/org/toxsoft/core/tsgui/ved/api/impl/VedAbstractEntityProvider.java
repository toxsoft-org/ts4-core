...
public abstract class VedAbstractEntityProvider
  ...
  @Override
  public <T extends IVedEntity> T create( String aId, IVedEnvironment aVedEnv, IVedEntityConfig aCfg ) {
    StridUtils.checkValidIdPath( aId );
    TsNullArgumentRtException.checkNulls( aVedEnv, aCfg );
    ...
    // create entity
    IVedEntity c = doCreateEntity( aId, aVedEnv, aCfg );
   ...
   */
  protected abstract IVedEntity doCreateEntity( String aId, IVedEnvironment aVedEnv, IVedEntityConfig aCfg );
