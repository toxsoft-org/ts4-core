...
/**
 * {@link IVedVertexSet} implementation for {@link ViselRoundRectEx} editing.
 *
 * @author vs
 */
class ViselRoundRectVertexSetEx
   ...
   * @return {@link ViselRoundRectVertexSetEx} - created instance of {@link IVedVertexSet}
   */
  static ViselRoundRectVertexSetEx create( VedAbstractVisel aVisel, VedScreen aVedScreen ) {
    ...
    v.setBackground( cm.getColor( ETsColor.YELLOW ) );
    vertexes.add( v );
    return new ViselRoundRectVertexSetEx( aVisel, vertexes, aVedScreen );
  }

  protected ViselRoundRectVertexSetEx( VedAbstractVisel aVisel, IStridablesList<? extends IVedVertex> aVertexes,
  ...
  protected void update( int aSwtDx, int aSwtDy, String aVertexId ) {
    ...
    ViselRoundRectEx roundRect = (ViselRoundRectEx)visel();
  ...
  protected void updateVertexes() {
    ...
    clearHiddenIds();
    ViselRoundRectEx baloon = (ViselRoundRectEx)visel();
