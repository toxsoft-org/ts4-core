...
/**
 * String/directory chooser edits values of type {@link String}.
 *
 * @author hazard157
 */
public class ValedStringFile
    extends AbstractValedControl<String, Composite> {

  /**
   * The factory name.
   */
  public static final String FACTORY_NAME = ITsLibInnerSharedConstants.TSLIB_VALED_STRING_FILE;
  ...
  static class Factory
    ...
    protected IValedControl<String> doCreateEditor( ITsGuiContext aContext ) {
      return new ValedStringFile( aContext );
    }
   ...
   */
  public ValedStringFile( ITsGuiContext aContext ) {
    super( aContext );
