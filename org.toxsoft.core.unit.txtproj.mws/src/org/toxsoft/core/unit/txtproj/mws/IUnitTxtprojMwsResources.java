package org.toxsoft.core.unit.txtproj.mws;
...
public interface IUnitTxtprojMwsResources {
  ...
  String STR_N_IS_REDUCED_TOOLBAR_BUTTONS = "Две кнопки?";
  String STR_D_IS_REDUCED_TOOLBAR_BUTTONS = "Признак, что тулюар будет содержать только две кнопки Открыть и Сохранить";
