...
import org.toxsoft.tslib.coll.primtypes.IIntListBasicEdit;
 ...
 * @author hazard157
 */
public final class SortedIntLinkedBundleList
   ...
   */
  public SortedIntLinkedBundleList( int aBundleCapacity, boolean aAllowDuplicates ) {
   ...
   */
  public SortedIntLinkedBundleList() {
   ...
   */
  public SortedIntLinkedBundleList( int... aElems ) {
    this();
   ...
   */
  public SortedIntLinkedBundleList( IIntList aSrc ) {
    this();
