...
public class Stridable
   ...
   * @throws TsIllegalArgumentRtException ID is not an IDpath
   */
  public Stridable( String aId, String aName, String aDescription ) {
   ...
   */
  public Stridable( String aId, String aName, String aDescription, boolean aAllowIdPath ) {
   ...
   * @throws TsNullArgumentRtException any argument = <code>null</code>
   */
  public Stridable( IStridable aSource ) {
