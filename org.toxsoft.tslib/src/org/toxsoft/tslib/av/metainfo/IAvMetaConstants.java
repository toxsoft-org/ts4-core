...
import static org.toxsoft.tslib.av.impl.DataDef.*;
import static org.toxsoft.tslib.av.metainfo.ITsResources.*;

import org.toxsoft.tslib.av.IAtomicValue;
import org.toxsoft.tslib.av.validators.*;
...
public interface IAvMetaConstants {
  ...
  String DDID_NAME        = DDID_PREFIX + ".name";
  String DDID_DESCRIPTION = DDID_PREFIX + ".description";
  ...
  IDataDef DDEF_NAME = create( DDID_NAME, STRING, //
  ...
  IDataDef DDEF_DESCRIPTION = create( DDID_DESCRIPTION, STRING, //
